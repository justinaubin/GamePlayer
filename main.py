...
from chess.chess_state import ChessGameState

from checkers.pieces import CheckerFactory
from checkers.checkers_state import CheckersGameState
...
class GameDriver:
    def __init__(self, player1=HumanPlayer(), player2=HumanPlayer(), history_enabled=False, game="chess"):
...
if __name__ == "__main__":
    ...
    game = GameDriver(player1, player2, history, game_type)
    game.start_game()
